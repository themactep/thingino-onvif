...
RUN apt-get update && apt-get install -y lighttpd libcjson1 libtomcrypt1
...
# Copy config file
COPY onvif_simple_server.conf.example /etc/onvif_simple_server.conf
...
RUN echo '#!/bin/bash\nexec /app/cgi-bin/onvif_simple_server -c /etc/onvif_simple_server.conf device_service' > /app/cgi-bin/device_service.cgi && \
    echo '#!/bin/bash\nexec /app/cgi-bin/onvif_simple_server -c /etc/onvif_simple_server.conf media_service' > /app/cgi-bin/media_service.cgi && \
    echo '#!/bin/bash\nexec /app/cgi-bin/onvif_simple_server -c /etc/onvif_simple_server.conf media2_service' > /app/cgi-bin/media2_service.cgi && \
    echo '#!/bin/bash\nexec /app/cgi-bin/onvif_simple_server -c /etc/onvif_simple_server.conf ptz_service' > /app/cgi-bin/ptz_service.cgi && \
    echo '#!/bin/bash\nexec /app/cgi-bin/onvif_simple_server -c /etc/onvif_simple_server.conf deviceio_service' > /app/cgi-bin/deviceio_service.cgi && \
    echo '#!/bin/bash\nexec /app/cgi-bin/onvif_simple_server -c /etc/onvif_simple_server.conf events_service' > /app/cgi-bin/events_service.cgi && \
