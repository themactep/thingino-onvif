...
if __name__ == "__main__":
    # Test with thingino credentials and show generated values
    username = "thingino"
    password = "thingino"
    ...
    # Generate authentication with fresh nonce/created
    auth = generate_ws_security_digest(username, password)
